...
{
    public class NotaDebitoXml : IDocumentoXml<DocumentoElectronico, DebitNote>
    {
        DebitNote IDocumentoXml<DocumentoElectronico, DebitNote>.Generar(DocumentoElectronico documento)
        {
