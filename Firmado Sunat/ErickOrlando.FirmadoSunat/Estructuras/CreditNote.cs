...
namespace ErickOrlando.FirmadoSunat.Estructuras
{
    ...
    public class CreditNote : IXmlSerializable
    {
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteValue(LegalMonetaryTotal.PayableAmount.value.ToString(Constantes.Constantes.FormatoNumerico));
            writer.WriteEndElement();
            ...
            foreach (var creditNoteLine in CreditNoteLines)
            {
                ...
                writer.WriteStartElement("cbc:CreditedQuantity");
                {
                    ...
                    writer.WriteValue(creditNoteLine.CreditedQuantity.Value.ToString(Constantes.Constantes.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                writer.WriteStartElement("cbc:LineExtensionAmount");
                {
                    ...
                    writer.WriteValue(creditNoteLine.LineExtensionAmount.value.ToString(Constantes.Constantes.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                if (creditNoteLine.AllowanceCharge.ChargeIndicator)
                {
                    ...
                    writer.WriteValue(creditNoteLine.AllowanceCharge.Amount.value.ToString(Constantes.Constantes.FormatoNumerico));
                    writer.WriteEndElement();
                    #endregion
                ...
                writer.WriteString(creditNoteLine.Price.PriceAmount.value.ToString(Constantes.Constantes.FormatoNumerico));
                writer.WriteEndElement();
